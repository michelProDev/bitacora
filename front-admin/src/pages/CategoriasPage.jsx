...
export default function CategoriasPage() {
  ...
  const api = useMemo(() => ({
    list: () => httpJson(`${baseUrl}/api/categorias`),
    get: (id) => httpJson(`${baseUrl}/api/categorias/${id}`),
    create: (payload) => httpJson(`${baseUrl}/api/categorias`, { method: 'POST', body: JSON.stringify(payload) }),
    updateByNombre: (nombre, payload) => httpJson(`${baseUrl}/api/categorias/nombre/${encodeURIComponent(nombre)}`, { method: 'PUT', body: JSON.stringify(payload) }),
    removeByNombre: (nombre) => httpJson(`${baseUrl}/api/categorias/nombre/${encodeURIComponent(nombre)}`, { method: 'DELETE' }),
    buscar: (nombre) => httpJson(`${baseUrl}/api/categorias/buscar?nombre=${encodeURIComponent(nombre)}`),
  }), [baseUrl]);
