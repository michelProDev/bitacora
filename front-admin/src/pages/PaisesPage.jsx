...
export default function PaisesPage() {
  ...
  const api = useMemo(() => ({
    list: () => httpJson(`${baseUrl}/api/paises`),
    get: (id) => httpJson(`${baseUrl}/api/paises/${id}`),
    create: (payload) => httpJson(`${baseUrl}/api/paises`, { method: 'POST', body: JSON.stringify(payload) }),
    updateByNombre: (nombre, payload) => httpJson(`${baseUrl}/api/paises/nombre/${encodeURIComponent(nombre)}`, { method: 'PUT', body: JSON.stringify(payload) }),
    removeByNombre: (nombre) => httpJson(`${baseUrl}/api/paises/nombre/${encodeURIComponent(nombre)}`, { method: 'DELETE' }),
    buscar: (nombre) => httpJson(`${baseUrl}/api/paises/buscar?nombre=${encodeURIComponent(nombre)}`),
  }), [baseUrl]);
